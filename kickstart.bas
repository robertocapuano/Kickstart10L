...
7 color 1,15,15:SCREEN 5,3,0: cls :KEYOFF:DEFINTA-Z: :open"grp:"as#1:M=0:C(0)=5:C(1)=1:C(2)=5:c(3)=14: SX=50:SY=25
...
100 if M<>255 then 8: else : pset(103,108):  color 4:print#1,"Kickstart": goto 100
